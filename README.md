![GitHub language](https://img.shields.io/github/languages/top/TangoMan75/pivot)
![GitHub license](https://img.shields.io/github/license/TangoMan75/pivot)
[![GitHub release](https://img.shields.io/github/v/release/TangoMan75/pivot?sort=semver)](https://github.com/TangoMan75/pivot/releases/)
[![GitHub release date](https://img.shields.io/github/release-date/TangoMan75/pivot)](https://github.com/TangoMan75/pivot/releases/)
![GitHub commit activity](https://img.shields.io/github/commit-activity/m/TangoMan75/pivot)
[![CI status](https://github.com/TangoMan75/pivot/workflows/CI%2FCD/badge.svg)](https://github.com/TangoMan75/pivot/actions/workflows/ci.yml)
![GitHub stars](https://img.shields.io/github/stars/TangoMan75/pivot)
...
- You can trigger toasts from JavaScript using the global `window.toast()` function:
...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/TangoMan75/pivot@latest/css/pivot.min.css">
</head>
<body>
    ...
    <script type="text/javascript" src="https://cdn.jsdelivr.net/gh/TangoMan75/pivot@latest/js/pivot.min.js"></script>
</body>
</html>
```
...
If you have npm installed, run the following command in the project's root directory:
...
To start the development environment or, use the following commands:
